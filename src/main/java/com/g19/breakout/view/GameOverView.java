...
public class GameOverView extends SuperView<View> implements View {
    ...
    public void draw() {
        ...
        graphics.drawCenteredString(new Position(60, 6), "Game Over", "#ffffff", backColor);

        String score = "Total score: " + playerModel.getPoints() + " points";
        graphics.drawCenteredString(new Position(60, 10), score, "#ffffff", backColor);

        graphics.drawCenteredString(new Position(60, 13), "Insert your name", "#ffffff", backColor);
